...
- Page 207: In the line immediately following the `mov qword ptr y[ebp], 123` instruction, "four-byte" should be "eight-byte". (Thanks to Owais Khan.)
- Page 230: In Listing 11-3 "`MsgLength`" should be "`msgLength`". (Thanks to Jürgen Hötzel.)
